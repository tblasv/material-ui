...
var LeftNav = React.createClass({
  ...
  _testDeprecations: function _testDeprecations() {
    warning(!(typeof this.props.onNavClose === 'function'), 'onNavClose will be removed in favor of onChangeRequest');

    warning(!(typeof this.props.onNavOpen === 'function'), 'onNavOpen will be removed in favor of onChangeRequest');
  },
