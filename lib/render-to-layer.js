...
var RenderToLayer = _react2.default.createClass({
  ...
  _checkClickAway: function _checkClickAway(e) {
    ...
    var el = this._layer;
    if (e.target !== el && !_dom2.default.isDescendant(el, e.target) && document.documentElement.contains(e.target)) {
  ...
  _unrenderLayer: function _unrenderLayer() {
    ...
    if (!this.reactUnmount) this.reactUnmount = (0, _lodash2.default)(function () {
      if (_this._layer) {
  ...
  _bindClickAway: function _bindClickAway() {
    this.canClickAway = true;
    _events2.default.on(document, 'mousedown', this._checkClickAway);
    _events2.default.on(document, 'touchend', this._checkClickAway);
    _events2.default.on(document, 'popOverOnShow', this._preventClickAway);
    _events2.default.on(document, 'popOverOnHide', this._allowClickAway);
  },
  _unbindClickAway: function _unbindClickAway() {
    _events2.default.off(document, 'mousedown', this._checkClickAway);
    _events2.default.off(document, 'touchend', this._checkClickAway);
    _events2.default.off(document, 'popOverOnShow', this._preventClickAway);
    _events2.default.off(document, 'popOverOnHide', this._allowClickAway);
  }
});
