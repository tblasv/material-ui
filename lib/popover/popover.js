...
var Popover = _react2.default.createClass({
  mixins: [_contextPure2.default, _stylePropable2.default, _windowListenable2.default],
  ...
  renderLayer: function renderLayer() {
    ...
    var horizontalAnimation = {
      ...
      transform: 'scaleX(0)',
      opacity: 1,
      transition: animated ? _transitions2.default.easeOut('250ms', ['transform', 'opacity']) : null,
      transformOrigin: horizontal + ' ' + targetOrigin.vertical
    };
  ...
  _animate: function _animate(el) {
    ...
    if (this.state.open) {
      ...
      _cssEvent2.default.onTransitionEnd(inner, function () {
        if (!_this2.state.open) _this2.requestClose();
      });
    }

    _autoPrefix2.default.set(el.style, 'transform', 'scale(' + value + ',' + value + ')');
    _autoPrefix2.default.set(innerInner.style, 'transform', 'scaleX(' + value + ')');
    _autoPrefix2.default.set(innerInnerInner.style, 'transform', 'scaleY(' + value + ')');
    _autoPrefix2.default.set(rootStyle, 'opacity', value);
    _autoPrefix2.default.set(innerStyle, 'opacity', value);
    _autoPrefix2.default.set(innerInnerInner, 'opacity', value);
    _autoPrefix2.default.set(el.style, 'opacity', value);
  },
