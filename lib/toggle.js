...
var Toggle = React.createClass({
  ...
  render: function render() {
    ...
    var trackStyles = this.mergeStyles(styles.track, this.props.trackStyle, this.state.switched && styles.trackWhenSwitched, this.state.switched && this.props.trackStyleWhenSwitched, this.props.disabled && styles.trackWhenDisabled);

    var thumbStyles = this.mergeStyles(styles.thumb, this.props.thumbStyle, this.state.switched && styles.thumbWhenSwitched, this.state.switched && this.props.thumbStyleWhenSwitched, this.props.disabled && styles.thumbWhenDisabled);
